...
def imageSiteDownloader(extension):
    ...
    for i, image in enumerate(image_elem):
        ...
        res.raise_for_status()
        image_file = open(os.path.join('/home/af/Downloads/imgur',
...
downloaded = imageSiteDownloader('jpg') + imageSiteDownloader('png')
