...
for quizNum in range(35):
    ...
    quizFile = open('/home/af/Dokumenter/Programs/AutomatetheBoringStuffwithPython-py38/data/'
                    'capitalsquiz%s.txt' % (quizNum + 1), 'w')
    answerKeyFile = open('/home/af/Dokumenter/Programs/AutomatetheBoringStuffwithPython-py38/data/'
                         'capitalsquiz_answers%s.txt' % (quizNum + 1), 'w')
